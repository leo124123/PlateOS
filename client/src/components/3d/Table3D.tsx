  ...
  return (
    ...
    >
      <mesh position={[0, 0.02, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <meshBasicMaterial color={statusColor} side={THREE.DoubleSide} transparent opacity={hovered ? 0.9 : 0.6} />
      </mesh>
      ...
      <mesh position={[0, 0.87, 0]}>
        ...
        <meshStandardMaterial color={statusColor} roughness={0.1} metalness={0.5} />
      </mesh>
      ...
      <Html position={[0, 1.5, 0]} center distanceFactor={14}>
        ...
        >
          <span className="w-3 h-3 rounded-full animate-ping" style={{ backgroundColor: statusColor }} />
